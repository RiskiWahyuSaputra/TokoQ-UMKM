...
<main class="app-main ml-64 min-h-screen">
    ...
    <section class="app-page p-container-padding space-y-card-gap">
        ...
        <div class="grid grid-cols-12 gap-card-gap">
            <div class="col-span-12 lg:col-span-7 bg-surface-container-lowest rounded-2xl border border-outline-variant p-8">
            ...
            <div class="col-span-12 lg:col-span-5 bg-surface-container-lowest rounded-2xl border border-outline-variant p-8">
        ...
        <div class="grid grid-cols-12 gap-card-gap">
            ...
            <div class="col-span-12 lg:col-span-7 bg-surface-container-lowest rounded-2xl border border-outline-variant overflow-hidden">
