                ...
                <ul class="space-y-4">
                    @forelse($insights as $insight)
                        <li class="flex items-start gap-4 p-4 rounded-2xl bg-white border border-outline-variant/30">
                            <span class="material-symbols-outlined text-tertiary text-[20px] mt-1">insights</span>
            ...
            <div class="bg-primary-container p-6 rounded-[24px] shadow-lg relative group cursor-pointer hover:scale-[1.02] transition-transform">
                <div class="relative z-10">
                    ...
                    <span class="flex items-center gap-2 font-bold text-on-primary-container">
                        Mulai Chat <span class="material-symbols-outlined">arrow_forward</span>
                    </span>
                </div>
                <span class="material-symbols-outlined absolute -bottom-4 -right-4 text-[120px] text-white/5 pointer-events-none">smart_toy</span>
            </div>
        </div>
    </div>
...
<footer class="app-footer p-container-padding pb-12 opacity-50 flex justify-between items-center">
    <p class="text-body-sm">&copy; 2024 TokoQ Digital Twin Management. All rights reserved.</p>
